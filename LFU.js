...
// // 需要绑定DoubleLinkedList必要的数据操作，删除某个链表节点，或者是头部插入
...
// DoubleLinkedList.prototype.removeFromList = function(node){
//     let tmp1= node.pre
//     let tmp2 = node.next
//     tmp1.next = tmp2
//     tmp2.pre = tmp1
...
//     let minLinkedList = this.freqMap.get(this.minFreq)
//     // 删除最后一个，也就是时间排在最后的
//     let tail = minLinkedList.tail.pre
//     minLinkedList.removeFromList(tail)
...
//     if(freq===this.minFreq && linkList.head.next == linkList.tail){
//         this.minFreq = freq + 1
//     }
//     node.freq++
